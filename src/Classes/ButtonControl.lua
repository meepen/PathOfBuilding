...
function ButtonClass:Draw(viewPort, noTooltip)
	...
	if self.image then
		...
		graphics:DrawImage(self.image, x + 2, y + 2, width - 4, height - 4)
	...
	if label == "+" then
		graphics:DrawImage(nil, x + width * 0.2, y + height * 0.45, width * 0.6, height * 0.1)
		graphics:DrawImage(nil, x + width * 0.45, y + height * 0.2, width * 0.1, height * 0.6)
	elseif label == "-" then
		graphics:DrawImage(nil, x + width * 0.2, y + height * 0.45, width * 0.6, height * 0.1)
	elseif label == "x" then
		graphics:DrawImageQuad(nil, x + width * 0.2, y + height * 0.3, x + width * 0.3, y + height * 0.2, x + width * 0.8, y + height * 0.7, x + width * 0.7, y + height * 0.8)
		graphics:DrawImageQuad(nil, x + width * 0.7, y + height * 0.2, x + width * 0.8, y + height * 0.3, x + width * 0.3, y + height * 0.8, x + width * 0.2, y + height * 0.7)
	else
		local overSize = self.overSizeText or 0
		graphics:DrawString(x + width / 2, y + 2 - overSize, "CENTER_X", height - 4 + overSize * 2, "VAR", label)
	end
	if mOver then
